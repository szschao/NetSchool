...
exports.config = {
  ...
  baseUrl: 'http://localhost:3000/test/acceptance/html/',
  //
  ...
  // in order to enhance it and build services around it.
  // You can either apply a single function to it or an array of
