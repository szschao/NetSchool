...
describe('Selector', function () {
  ...
  it('To get an anchor element with a specific text in it,' +
    ...
    expect(browser.getAttribute('=WebdriverIO', 'href')).
      to.
      have.
      string('http://webdriver.io');
  });
  ...
  context('Element with certain text', function () {
    ...
    it('query a level 1 heading with the text “Welcome to my Page”',
      function () {
        browser.url(BASE_URL + 'webdriverio-selector.html');

        expect(browser.getText('h1=Welcome to my Page')).
          to.
          have.
          string('Welcome to my Page');
        expect(browser.getTagName('h1=Welcome to my Page')).
          to.
          have.
          string('h1');
      });
    ...
    it('query partial text', function () {
      ...
      expect(browser.getText('h1*=Welcome')).
        to.
        have.
        string('Welcome to my Page');
      expect(browser.getText('h1[alt*="welcome"]')).
        to.
        have.
        string('Welcome to my Page');
    });
    ...
    it('same works for ids and class names', function () {
      ...
      expect(browser.getText('.someElem=WebdriverIO is the best')).
        to.
        have.
        string('WebdriverIO is the best');
  ...
  it('To query an element with a specific tag name', function () {
    ...
    expect(browser.getText('<p>')).to.have.string('Hello WebDriver');
  });

  it('For querying elements with a specific name attribute', function () {
    browser.url(BASE_URL + 'webdriverio-selector.html');

    expect(browser.getText('[name="someName"]')).to.have.string('some name');
  });
