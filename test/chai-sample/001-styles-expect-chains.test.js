...
describe('chai expect', function () {
  ...
  it('.nested - Enables dot- and bracket-notation in all .property ' +
    ...
    // If . or [] are part of an actual property name,
    // they can be escaped by adding two backslashes before them.
  ...
  it('.any - Sets the any flag, (opposite of the all flag) ' +
    'later used in the keys assertion.', function () {

    expect(foo).to.have.any.keys('bar', 'baz');
    expect({a: 1, b: 2}).to.not.have.any.keys('c', 'd');
  });

  it('.all - Sets the all flag (opposite of the any flag) ' +
    'later used by the keys assertion.', function () {

    expect(foo1).to.have.all.keys('bar', 'baz');
    expect({a: 1, b: 2}).to.have.all.keys('a', 'b');
  });

  it('.a(type) - The a and an assertions are aliases ' +
  ...
  it('.include - The include and contain assertions can be used ' +
    'as either property based language chains or ' +
    'as methods to assert the inclusion of an object ' +
    'in an array or a substring in a string. ', function () {
  ...
  it('.exit - Asserts that the target is neither null nor undefined.',
    function () {
      expect(1).to.equal(1); // Recommended
  ...
  it('.arguments - Asserts that the target is an arguments object.',
    function () {
      function test () {
  ...
  it('.eql(obj[,msg]) - Asserts that the target is deeply equal to value.',
    function () {
      expect({foo: 'bar'}).to.eql({foo: 'bar'});
      expect([1, 2, 3]).to.eql([1, 2, 3]);
    });

  it('.above(value) - Asserts that the target is greater than value.',
    function () {
  ...
  it('.below(value) - Asserts that the target is less than value.',
    function () {
  ...
  it('.most(value) - Asserts that the target is less than or equal to value.',
    function () {
  ...
  it('.within(start,finish) - Asserts that the target is within a range.',
    function () {
  ...
  it('.ownProperty(name) - Asserts that the target has an own property name.',
    function () {
      expect('test').to.have.ownProperty('length');
    });

  it('.ownPropertyDescriptor(name[, descriptor[, message]]) ' +
    '- Asserts that the target has an own property descriptor name,' +
    ' that optionally matches descriptor.', function () {
    ...
    expect('test').
      ...
      to.
      have.
      keys('configurable', 'enumerable', 'value', 'writable');

    expect({a: 1}).
      to.
      have.
      ownPropertyDescriptor('a').
      that.
      has.
      property('enumerable', true);
  });

  it('.length - Sets the doLength flag later used as a chain precursor ' +
    'to a value comparison for the length property.', function () {
  ...
  it('.lengthOf(value[, message]) - Asserts that the target’s length property' +
    ' has the expected value.', function () {
  ...
  it('.match(regexp) - Asserts that the target matches a regular expression.',
    function () {
      expect('foobar').to.match(/^foo/);
    });

  it('string(string) - Asserts that the string target contains another string.',
    function () {
      expect('foobar').to.have.string('bar');
    });

  it('.keys(key1, [key2], […]) - Asserts that the target contains any or ' +
    'all of the passed-in keys. ', function () {
  ...
  it(
    '.throw(constructor) - Asserts that the function target will throw a specific error,' +
    ...
    function () {
      ...
      err = new TypeError('Illegal salmon!');
      err.code = 42;
      badFn = function () {
        throw err;
      };
  ...
  it('.respondTo(method) - Asserts that the object or ' +
    'class target will respond to a method.', function () {
  ...
  it('.itself - Sets the itself flag, later used by the respondTo assertion.',
    function () {
      function Cat () {
      }
  ...
  it('.satisfy(method) - Asserts that the target passes a given truth test.',
    function () {
  ...
  it('.closeTo(expected, delta) - Asserts that the target is equal expected, ' +
    'to within a +/- delta range.', function () {

    expect(1.5).to.be.closeTo(1, 0.5);
  });

  it('.members(set) - Asserts that the target is a superset of set,' +
  ...
  it('ordered - Causes all .members assertions that follow in the chain ' +
    'to require that members be in the same order.', function () {
    expect([1, 2]).
      to.
      have.
      ordered.
  ...
  it('.oneOf(list) - Assert that a value appears somewhere' +
    ' in the top level of array list.', function () {
  ...
  it('.change(function) - Asserts that a function changes an object property',
    function () {
      var dots = '',
        addDot = function () {
          dots += '.';
  ...
  it(
    '.decrease(function) - Asserts that a function decreases an object property',
    function () {
      var val = 1,
  ...
  it('.by(delta[, msg]) - When following an .increase assertion in the chain,' +
    '.by asserts that the subject of the .increase assertion increased ' +
    'by the given delta.', function () {
  ...
  it('.extensible - Asserts that the target is extensible ' +
    '(can have new properties added to it).', function () {
  ...
  it('.sealed - Asserts that the target is sealed ' +
    '(cannot have new properties added to it and ' +
    'its existing properties cannot be removed).', function () {
  ...
  it('.frozen - Asserts that the target is frozen ' +
    '(cannot have new properties added to it and ' +
    'its existing properties cannot be modified).', function () {
  ...
  it('.finite - Asserts that the target is a number, ' +
    'and isn’t NaN or positive/negative Infinity.', function () {
