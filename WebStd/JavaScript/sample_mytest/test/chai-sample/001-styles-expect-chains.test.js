...
describe('chai expect', function () {
    ...
    it('.a(type) - The a and an assertions are aliases ' +
        'that can be used either as language chains or to assert a value’s type.', function () {
    ...
    it('.ownPropertyDescriptor(name[, descriptor[, message]]) ' +
        ...
        expect('test').ownPropertyDescriptor('length').to.have
    ...
    it('.throw(constructor) - Asserts that the function target will throw a specific error,' +
        ' or specific type of error (as determined using instanceof)', function () {
    ...
    it('.members(set) - Asserts that the target is a superset of set,' +
        ' or that the target and set have the same strictly-equal (===) members.', function () {
